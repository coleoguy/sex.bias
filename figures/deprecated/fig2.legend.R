...
library(ggpubr)
fig.2 <- ggarrange(dominance, rd, selection, autosomal, xchrom, ychrom, haplodiploidy.fem, 
          haplodiploidy.mal, esd, widths = c(3, 3, 3),
          ncol = 3, nrow = 3)
...
# g9 <- ggplotGrob(esd)
# 
# g <- rbind(g1, g2, g3, g4, g5, g6, g7, g8, g9, size =)
# 
# g$heights <- unit.pmax(g1$widths, g2$widths, g3$widths, g4$widths, g5$widths, g6$widths, g7$widths,
#                         g8$widths, g9$widths)
# grid.newpage()
# grid.draw(g)
# 

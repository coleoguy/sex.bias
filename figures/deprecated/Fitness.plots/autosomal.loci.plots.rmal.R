...
# Autosomal loci plots for rare males
...
ggsave(filename = "fem.com.auto_h_0_s_0.5.pdf",
...
p <- ggplot(data = melted_result, 
  ...
  theme(legend.text = element_text(size=7),
        ...
        axis.text.x = element_text(size=7),
        axis.text.y = element_text(size=7)) 
ggsave(filename = "fem.com.auto_h_.5_s_0.5.pdf",
       plot=p, width=5, height=4, units="in")
...
p <- ggplot(data = melted_result, 
  ...
  theme(legend.text = element_text(size=7),
        ...
        axis.text.x = element_text(size=7),
        axis.text.y = element_text(size=7)) 
ggsave(filename = "fem.com.auto_h_1_s_0.5.pdf",
       plot=p, width=5, height=4, units="in")

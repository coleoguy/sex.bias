...
ggplot(wbar, aes(x=category, y=max.w)) +
  geom_segment(aes(x=category, xend=category, y=wbar.m, yend=max.w), 
               size=1, data=wbar, colour="black", linetype="solid", alpha= 0.5) +
  geom_segment(aes(x=category2, xend=category2, y=wbar.f, yend=max.w), 
               size=1, data=wbar, colour="blue", linetype="solid", alpha= 0.5) +
  geom_point(aes(x= category, y=wbar.m), data= wbar, size=4, colour= "black", alpha = 0.5) +
  geom_point(aes(x= category, y=max.w), data= wbar, size=4, colour= "black", alpha = 0.5) +
  geom_point(aes(x= category2, y=wbar.f), data= wbar, size=4, colour= "blue", alpha = 0.5) +
  geom_point(aes(x= category2, y=max.w), data= wbar, size=4, colour= "blue", alpha = 0.5) +

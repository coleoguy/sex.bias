...
# This script simulates a subset of conditions in our XY model where bias 
# ranges from 0.2 to 0.05 and we test different recombination distances 
# to determine more accurately the inflection point at
# which significant changes in the fitness of one sex takes place.

# More precisely, in these simulations females are the common sex and males 
# are the rare sex.

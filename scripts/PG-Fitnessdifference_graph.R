...
#checking values "Don't run
#mfit.sex.5h <- mfit.sex.5h[mfit.sex.5h$females == 1000,]
#mfit.sex.5h <- mfit.sex.5h[mfit.sex.5h$OSR == 1.0,]
...
my_labels = c("0.50","0.25","0.00","0.25","0.50")
my_ticks = c(-0.50,-0.25,0,0.25,0.5)
